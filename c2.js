...
function C2() {
  ...
  function isInteger(value){
    ...
    function f4(eve){
        if((document.getElementById("name").value.trim()!="")&&(document.getElementById("roll_number").value.trim()!=""))   return;
        if(eve.target.value=="All"){
            setArr([...arr2]);
        }
        else{
            let a=[...arr2];
            let b=a.filter(e=>eve.target.value==e.course);
            setArr(b);
        }
    }
        ...
        <div style={{alignItems:"center",alignItems:"center"}}>
          ...
          <table style={{justifyContent: "center"}}>
            ...
            <tr>
              ...
              <td><select onChange={f4} id="branch" >
            ...
            <tbody id="tab">
            {arr.map((e,i)=>
                    <TableRow sno={i+1} rollno={e.rollno} name={e.name} course={e.course} age={e.age} />
                )}
